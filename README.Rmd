...
There are two main functions in **sentimentr** with two helper functions summarized in the table below:
...
| `get_sentences`  | Regex string to sentence parser (or get sentences from `sentiment`/`sentiment_by`|
