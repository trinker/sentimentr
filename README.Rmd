...
To combine by element (column cell or vector element) use `sentiment_by` with `by = NULL`.
...
To combine by grouping variables use `sentiment_by` using the `by` argument.
